...
echo "package org.muzir.codechef.practice.beginner;public class $1Test {@Test public void test(){}}" > src/test/java/org/muzir/codechef/practice/beginner/$1Test.java
echo $1
